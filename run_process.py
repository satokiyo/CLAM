...
convert2DF = False
row_indices = False
folder = "/media/prostate/sample_ndpi/reannotate"  # Linux-filesystem directory to read raw WSI data
save_folder = "/media/prostate/20210331_PDL-1/result"  # Hadoop-supported directory in which to save DataFrames


# Process train & val slides
train_rdd = preprocess(spark, train.index, tile_size=tile_size, sample_size=sample_size,
                      grayscale=grayscale, folder=folder)
